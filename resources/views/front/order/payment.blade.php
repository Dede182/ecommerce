            ...
            <button type="button" class="flex items-center justify-between w-full p-5 bg-white rounded-lg"
             data-accordion-target="#accordion-collapse-body-1" aria-expanded="true" aria-controls="accordion-collapse-body-1">
              ...
              <span class="flex items-center space-x-4">
                <input type="radio" id="cod" checked name="payment"  class="w-4 h-4 mt-1 text-green-500 bg-gray-100 border-gray-300 focus:ring-green-700
        ...
        <h2 id="accordion-collapse-heading-2">
            <button type="button" class="flex items-center justify-between w-full p-5 bg-white rounded-lg"
             data-accordion-target="#accordion-collapse-body-2" aria-expanded="true" aria-controls="accordion-collapse-body-1">
              ...
              <span class="flex items-center space-x-4">
                <input type="radio" checked name="payment"  class="w-4 h-4 mt-1 text-green-500 bg-gray-100 border-gray-300 focus:ring-green-700
              focus:ring-2 "><p>My wallet</p></span>
              <svg data-accordion-icon class="w-6 h-6 rotate-180 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
            </button>
          </h2>
            ...
            <div class="px-5 pb-3 font-semibold text-sm bg-white">
                ...
                <div class="flex w-full" >
                    <div class="flex  w-full items-center space-x-3 font-normal">
                        <input type="radio" name="pay" checked class="w-4 h-4 mt-1 text-green-500 bg-gray-100 border-gray-300 focus:ring-green-700
                        focus:ring-2 " id = "payment1">
                        <label for="payment1">Amazon pay</label>
                    </div>
                    <div class="flex w-full  items-center space-x-3 font-normal">
                        <input type="radio" name="pay" class="w-4 h-4 mt-1 text-green-500 bg-gray-100 border-gray-300 focus:ring-green-700
                        focus:ring-2 " id = "payment1">
