                    ...
                    <div class="flex flex-col pb-3 border-b ">
                        ...
                        <div class="flex justify-between items-center">
                            <div class="flex items-center mt-4">
                                ...
                                @if (isset($product->discount))
                                    <span class="text-greu ml-2 font-bold text-xs">({{ $product->discount }}% Off)</span>
                                @endif
                            </div>
                        ...
                        <div class="whitespace-pre-line">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis dolorem exercitationem aperiam tempore odio? Voluptatum fugit sapiente nesciunt, modi tempora vel suscipit?</p>
                        </div>
                    </div>
