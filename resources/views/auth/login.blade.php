<x-guest-layout>
    ...
    <div class="flex justify-between items-center px-28 py-4 bg-gray-100">
        ...
        <div class="flex items-center">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="#000" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4">
              ...
              <div class="mb-6 font-Inter">
                ...
                <p class="text-gray-500">Log in your account</p>
            </div>
        </div>
    </div>
    ...
    <div class="flex items-center justify-center space-x-20">
        <div class="">
            ...
            loop
            mode="normal"
            src="{{ asset('svg/107385-login.json') }}"
            style="width: 320px"
          >
          </lottie-player>
        </div>
        ...
        <x-auth-card>
            ...
            <div class="mb-6 font-Inter">
                <h1 class="text-2xl">Welcome to fastcart</h1>
                <p class="text-gray-500">Log in your account</p>
            </div>
